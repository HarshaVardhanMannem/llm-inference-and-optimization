"""Fix text contrast issues in notebook styling"""
import json

with open('bert_distillbert_knowledge_distillation.ipynb', 'r', encoding='utf-8') as f:
    nb = json.load(f)

# Fixed styling with proper text contrast
fixed_styling = {
...
<ul style="margin: 0; padding-left: 20px; color: #212529;">
<li style="color: #212529;">DistilBERT is architecturally similar to BERT but with fewer layers</li>
<li style="color: #212529;">Both use the same tokenizer, making knowledge transfer easier</li>
<li style="color: #212529;">Size reduction enables <strong style="color: #000;">faster inference</strong> and <strong style="color: #000;">lower memory usage</strong></li>
</ul>
</div>
''',
...
<p style="color: #212529;">This custom trainer extends Hugging Face's <code style="background: #f5f5f5; padding: 2px 6px; border-radius: 3px; color: #000;">Trainer</code> to implement knowledge distillation.</p>
</div>
...
<p style="margin-bottom: 5px; color: white;"><code style="background: rgba(255,255,255,0.2); padding: 2px 6px; border-radius: 3px; color: white;">temperature=2.0</code></p>
...
<p style="margin-bottom: 5px; color: white;"><code style="background: rgba(255,255,255,0.2); padding: 2px 6px; border-radius: 3px; color: white;">loss_distill</code></p>
<ul style="margin: 0; padding-left: 20px; font-size: 0.9em; color: white;">
...
<p style="margin-bottom: 5px; color: white;"><code style="background: rgba(255,255,255,0.2); padding: 2px 6px; border-radius: 3px; color: white;">alpha=0.5</code></p>
<ul style="margin: 0; padding-left: 20px; font-size: 0.9em; color: white;">
...
<h3 style="margin-top: 0; color: #212529;">📊 Dataset: SST-2 (Stanford Sentiment Treebank)</h3>
<ul style="margin: 0; padding-left: 20px; color: #212529;">
...
<p style="margin-bottom: 0; color: white;">Compares multiple model variants across key metrics</p>
</div>
...
<div style="color: #212529;"><strong>Accuracy</strong></div>
...
<div style="font-size: 1.2em; font-weight: bold;">💾</div>
<div style="color: #212529;"><strong>Model Size</strong></div>
...
<div style="font-size: 1.2em; font-weight: bold;">⚡</div>
<div style="color: #212529;"><strong>Latency</strong></div>
...
<th style="padding: 10px; text-align: center; color: white;">Accuracy</th>
<th style="padding: 10px; text-align: center; color: white;">Size</th>
<th style="padding: 10px; text-align: center; color: white;">Speed</th>
</tr>
...
<p style="color: white;">After successful distillation, upload the student model to Hugging Face Hub for:</p>
</div>
...
# Update markdown cells with fixed styling
...
print('Fixed text contrast issues!')
print('  - Added explicit dark text colors (#212529, #000)')
print('  - Fixed tip box text color (#155724)')
print('  - Ensured all text is readable')
print('  - Maintained visual styling')
